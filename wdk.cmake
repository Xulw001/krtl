...
macro(wdk_clean_default_options)
    swap_variable(CMAKE_C_FLAGS CMAKE_C_FLAGS_OLD)
    swap_variable(CMAKE_CXX_FLAGS CMAKE_CXX_FLAGS_OLD)
    ...
    swap_variable(CMAKE_C_FLAGS_DEBUG CMAKE_C_FLAGS_DEBUG_OLD)
    swap_variable(CMAKE_CXX_FLAGS_DEBUG CMAKE_CXX_FLAGS_DEBUG_OLD)
    # string(REPLACE "/O2" "/Ox" CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE}")
    # string(REPLACE "/Ob2" "" CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE}")

    swap_variable(CMAKE_C_STANDARD_LIBRARIES CMAKE_C_STANDARD_LIBRARIES_OLD)
    swap_variable(CMAKE_CXX_STANDARD_LIBRARIES CMAKE_CXX_STANDARD_LIBRARIES_OLD)

    swap_variable(CMAKE_EXE_LINKER_FLAGS CMAKE_EXE_LINKER_FLAGS_OLD)
endmacro()

macro(wdk_restore_default_options)
    swap_variable(CMAKE_C_FLAGS_OLD CMAKE_C_FLAGS)
    swap_variable(CMAKE_CXX_FLAGS_OLD CMAKE_CXX_FLAGS)
    
    swap_variable(CMAKE_C_FLAGS_DEBUG_OLD CMAKE_C_FLAGS_DEBUG)
    swap_variable(CMAKE_CXX_FLAGS_DEBUG_OLD CMAKE_CXX_FLAGS_DEBUG)

    swap_variable(CMAKE_C_STANDARD_LIBRARIES_OLD CMAKE_C_STANDARD_LIBRARIES)
    swap_variable(CMAKE_CXX_STANDARD_LIBRARIES_OLD CMAKE_CXX_STANDARD_LIBRARIES)

    swap_variable(CMAKE_EXE_LINKER_FLAGS_OLD CMAKE_EXE_LINKER_FLAGS)
endmacro()
